...
EOF
  ...
  # 下载需要的应用
  wget -O /tmp/dashboard.zip ${GH_PROXY}https://github.com/naiba/nezha/releases/download/v0.18.11/dashboard-linux-$ARCH.zip
  ...
  wget -O $WORK_DIR/nezha-agent.zip ${GH_PROXY}https://github.com/nezhahq/agent/releases/download/v0.17.5/nezha-agent_linux_$ARCH.zip
